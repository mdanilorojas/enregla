  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[520px] relative overflow-hidden flex-col justify-between p-10 login-brand-panel">
        {/* Animated gradient background - usando blue-900 (#1e3a8a) como base */}
        ...
        {/* Floating orbs */}
        <div className="absolute top-20 -left-10 w-60 h-60 rounded-full bg-blue-600/20 blur-3xl login-float" />
        <div className="absolute bottom-32 right-0 w-48 h-48 rounded-full bg-blue-700/20 blur-3xl login-float-delayed" />
        <div className="absolute top-1/2 left-1/3 w-32 h-32 rounded-full bg-blue-500/15 blur-2xl login-float-slow" />
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm">
            <div className="flex -space-x-2">
              {['bg-amber-400', 'bg-green-500', 'bg-blue-500', 'bg-red-500'].map((c, i) => (
                <div key={i} className={`w-7 h-7 rounded-full ${c} border-2 border-blue-900 flex items-center justify-center`}>
            ...
            <div>
              ...
              <p className="text-[10px] text-blue-200/50">Ecuador · Colombia · Perú</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10 bg-[#FAFBFC]">
        <div className="w-full max-w-[400px]">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-10">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-900 to-blue-800 flex items-center justify-center shadow-lg shadow-blue-900/20">
            ...
            <div>
              ...
              <span className="text-[10px] text-gray-500 font-semibold uppercase tracking-[0.15em]">Compliance</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-11 bg-gradient-to-r from-blue-900 to-blue-800 hover:from-blue-800 hover:to-blue-700 text-white font-semibold shadow-lg shadow-blue-900/25 hover:shadow-xl hover:shadow-blue-900/30"
            >
              {loading ? (
