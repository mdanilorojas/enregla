...
import { login, signInWithOAuth } from '@/lib/api/auth';
        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-white border border-gray-200 text-[13px] font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 active:scale-[0.98] transition-all duration-200"
            >
            ...
            <button
              type="button"
              disabled
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-white border border-gray-200 text-[13px] font-medium text-gray-400 cursor-not-allowed opacity-50"
              title="Próximamente"
            >
