    ...
    <div className={embedded ? 'h-full relative' : 'h-[calc(100vh-64px)] relative'}>
      ...
      >
        ...
        <Controls
          ...
          className="!bg-white !border-gray-100 !rounded-xl !shadow-lg !shadow-black/5 [&>button]:!border-gray-100 [&>button]:!rounded-lg [&>button:hover]:!bg-gray-50"
        />
        <MiniMap
          nodeColor={(n) => {
          ...
          className="!bg-white !border-gray-100 !rounded-xl !shadow-lg !shadow-black/5"
          pannable
          zoomable
        />
      </ReactFlow>
      ...
      {/* Legend */}
      <div className={`absolute ${embedded ? 'bottom-3 left-3' : 'bottom-6 left-6'} bg-white/90 backdrop-blur-sm rounded-xl border border-gray-100/80 shadow-lg ${embedded ? 'px-3 py-2' : 'px-4 py-3'} z-10`}>
