...
USING (id = public.user_company_id() AND public.user_role() = 'admin');
...
USING (company_id = public.user_company_id() AND public.user_role() IN ('admin', 'operator'));
...
USING (company_id = public.user_company_id() AND public.user_role() = 'admin');
